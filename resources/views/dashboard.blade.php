        ...
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-black-800 dark:text-black-200 leading-tight">
                ...
                <div class="hidden sm:flex sm:items-center sm:space-x-4">
                    <a href="{{ route('feedback.index') }}" class="inline-flex items-center px-4 py-2 bg-blue-100 border border-transparent rounded-md font-semibold text-xs text-blue-700 uppercase tracking-widest hover:bg-blue-200 active:bg-blue-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition ease-in-out duration-150">Avis</a>
                    <a href="{{ route('monitor-report.index') }}" class="inline-flex items-center px-4 py-2 bg-purple-100 border border-transparent rounded-md font-semibold text-xs text-purple-700 uppercase tracking-widest hover:bg-purple-200 active:bg-purple-300 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 transition ease-in-out duration-150">Rapports Moniteurs</a>
                    <a href="{{ route('programme') }}" class="inline-flex items-center px-4 py-2 bg-green-100 border border-transparent rounded-md font-semibold text-xs text-green-700 uppercase tracking-widest hover:bg-green-200 active:bg-green-300 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition ease-in-out duration-150">Programme</a>
                    <a href="{{ route('reports.daily') }}" class="inline-flex items-center px-4 py-2 bg-green-600 border border-transparent rounded-md font-semibold text-xs text-black uppercase tracking-widest hover:bg-green-500 active:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition ease-in-out duration-150">Générer le rapport du jour</a>
                    <a href="{{ route('children.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">Liste des Enfants</a>
                </div>

                <div class="sm:hidden">
                    <div class="flex flex-wrap justify-end gap-2 mb-2">
                        <a href="{{ route('feedback.index') }}" class="inline-flex items-center px-3 py-2 bg-blue-100 border border-transparent rounded-md font-semibold text-xs text-blue-700 uppercase tracking-widest">Avis</a>
                        <a href="{{ route('monitor-report.index') }}" class="inline-flex items-center px-3 py-2 bg-purple-100 border border-transparent rounded-md font-semibold text-xs text-purple-700 uppercase tracking-widest">Rapports Moniteurs</a>
                        <a href="{{ route('programme') }}" class="inline-flex items-center px-3 py-2 bg-green-100 border border-transparent rounded-md font-semibold text-xs text-green-700 uppercase tracking-widest">Programme</a>
                    </div>
                    <div class="flex flex-wrap justify-end gap-2">
                        <a href="{{ route('reports.daily') }}" class="inline-flex items-center px-3 py-2 bg-green-600 border border-transparent rounded-md font-semibold text-xs text-black uppercase tracking-widest">Générer le rapport du jour</a>
                        <a href="{{ route('children.index') }}" class="inline-flex items-center px-3 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest">Liste des Enfants</a>
                    </div>
                </div>
